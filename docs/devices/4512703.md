...
### Pairing
Factory reset:
- Press and hold down top two buttons until LED turns on.
- Immediately short press 5 times continuously on top left button, indicator flashes 3 times quickly to indicate successful reset.

Pairing mode:
- Press and hold down top two buttons until LED turns on.
- Immediately short press top right button, indicator flashes every 1 second. LED will then blink 5 times quickly for successful pairing.
